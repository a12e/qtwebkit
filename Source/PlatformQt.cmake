...
get_target_property(Qt6@MODULE_NAME@_INCLUDE_DIRS        Qt6::@MODULE_NAME@ INTERFACE_INCLUDE_DIRECTORIES)
get_target_property(Qt6@MODULE_NAME@_COMPILE_DEFINITIONS Qt6::@MODULE_NAME@ INTERFACE_COMPILE_DEFINITIONS)
...
get_target_property(_configurations Qt6::@MODULE_NAME@ IMPORTED_CONFIGURATIONS)
list(FIND _configurations RELEASE _index)
if (\${_index} GREATER -1)
    list(REMOVE_AT _configurations \${_index})
    list(INSERT _configurations 0 RELEASE)
    set_property(TARGET Qt6::@MODULE_NAME@ PROPERTY IMPORTED_CONFIGURATIONS \"\${_configurations}\")
endif ()
